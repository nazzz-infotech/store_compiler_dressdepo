...
interface OctagonDoc extends GenericStyleDoc {
...
interface Props extends OctagonDoc {
  children?: ReactNode;
}
...
function Octagon({
  ...
  return (
    <div className="dsc:relative">
      ...
      <div className="dsc:relative dsc:z-10 octagon dsc:flex dsc:flex-col dsc:items-center dsc:justify-center" style={style}>
        {imageUrl && (
          <img
