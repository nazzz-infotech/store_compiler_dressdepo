...
interface HeartDoc extends GenericStyleDoc {
...
interface Props extends HeartDoc {
  children?: ReactNode;
}
...
function Heart({
  ...
  return (
    <div className="dsc:relative">
      ...
      <div className="dsc:relative dsc:z-10 heart dsc:flex dsc:flex-col dsc:items-center dsc:justify-center" style={style}>
        {imageUrl && (
          <img
